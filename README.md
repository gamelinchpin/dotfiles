...
* [Fonts](/simeonpashley/dotfiles/tree/master/conf/osx/fonts) via the [init/50_osx_fonts.sh](init/50_osx_fonts.sh) script
...
If you modify things and notice a bug or an improvement, [file an issue](https://github.com/simeonpashley/dotfiles/issues) or [a pull request](https://github.com/simeonpashley/dotfiles/pulls) and let me know.
...
You might want to set up your ubuntu server [like I do it](https://github.com/simeonpashley/dotfiles/wiki/ubuntu-setup), but then again, you might not.
